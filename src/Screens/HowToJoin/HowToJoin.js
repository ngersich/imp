            ...
            <Stack spacing={2} marginRight={{xs: '20px', md: '100px'}} marginLeft={{xs: '20px', md: '100px'}} marginTop={{xs: 5, md: 15}} marginBottom={{xs: 5, md: 10}} >
                <Stack direction={{xs: 'column', md: "row"}} spacing={10} alignItems={{xs: 'center', md: 'center'}}>
                    ...
                    <Box width={{xs: '100%', md: '55%'}}>
                        ...
                        <Typography variant="h5" color="secondary" sx={{paddingTop: '10px'}}><b>Applications for Spring 2025 have closed. Fill out our interest form below, and we'll contact you when applications open!</b></Typography>
                        {/* <Typography variant="h5" color="secondary" sx={{paddingTop: '10px'}}>Applications for Spring 2025 are now open! Applications are due <b>Friday, January 31 at 11:59 PM CST</b>.</Typography> */}
                        <Stack>
                            <Stack sx={{width: {sm: '100%', lg: '90%'}, marginTop: '20px'}}>
                                <Stack alignItems='center'>
                                    ...
                                    {/* <ApplyButton text='Spring 2025 Mentor Application' href='https://forms.gle/PSEyhwQ8ujT1LT9K7'/> */}
                                </Stack>
                                <ol className="orderedListStyle">
                                    ...
                                    <ul>
                                        ...
                                        {/* <li><Typography variant="body1" color="text.secondary" fontWeight="bold">Sunday, 1/26 from 7-8 pm in Lincoln Hall Room 1002</Typography></li> */}
                                        {/* <li><Typography variant="body1" color="text.secondary" fontWeight="bold">Wednesday, 1/29 from 7-8 pm on {<Link href="https://illinois.zoom.us/j/3321619389?pwd=QkU4SFUyUjVteXhyRFd0NUNjMURVQT09">Zoom</Link>}</Typography></li> */}
